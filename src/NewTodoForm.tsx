  ...
  return (
    <section aria-label="New Todo">
      ...
      <form action="/api/todos" method="POST" className="inline-form">
        ...
        <label>
          <input aria-label="Title" autoComplete="off" autoFocus={((props.referrer.state === 'DELETE_TODO' && props.todos?.length === 0) || (props.referrer.state === 'ADD_TODO')) ? true : undefined} type="text" name="title" placeholder="Title" />
        </label>
